                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="blog-post">
                            ...
                            <p class="mt-3">Как внедрить несколько значимых фишек на своем новом сайте и выйти в
                                топ, даже если вы до этого не занимались SEO.</p>
                            <a href="blog-single.html" class="read-more">Читать статью <i
                    ...
                    <div class="col-lg-6">
                        <div class="blog-post">
                            ...
                            <p class="mt-3">Отвечаю на больной вопрос от наших клиентов: стоит ли использовать
                                шаблоны для сайта в своих проектах.</p>
                            <a href="blog-single.html" class="read-more">Читать статью <i
                                    class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="blog-post">
                            ...
                            <p class="mt-3">Поисковая выдача — это всегда конкуренция. Но что делать, чтобы
                                конкуренты остались позади вас? Отвечаю в статье</p>
                            <a href="blog-single.html" class="read-more">Читать статью <i
                                    class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="blog-post">
                            ...
                            <p class="mt-3">Существуют сервисы, котоорые могут помочь продвинуть сайт по СЕО, но
                                есть и мошенники, которые могут оставить вас без денег.</p>
                            <a href="blog-single.html" class="read-more">Читать статью <i
                                    class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="sidebar-widget about-bar">
                            ...
                            <p>Мы — маркетинговое агентство полного цикла, которое оказывает диджитал услуги
                                стартапам и крупным компаниям</p>
                        </div>
                    </div>
